...
export default function FeedPost({ post }: any) {
    ...
    return (
        <div className="w-2/3 rounded-lg text-lg bg-white p-8 m-4 ml-10 border-2 shadow-lg">
            ...
            {
                post.map((class_switch: any, i: number) => {
            ...
            <div>
                <button className="rounded-lg p-2 text-md mt-4 float-right text-white bg-[#018ccb] shadow-md hover:bg-[#007cb6]">Aceitar Troca</button>
            </div>
        </div>
    );
}
